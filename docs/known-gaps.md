...
add`/`list`/`remove` (`cli.py`) all shipped in this branch. Full design:
[`docs/superpowers/specs/2026-08-15-corporate-actions-design.md`](superpowers/specs/2026-08-15-corporate-actions-design.md).
Six gaps came out of that work — the five named in the design's §9, plus a sixth the
implementation review surfaced — deliberately deferred rather than fixed here:
