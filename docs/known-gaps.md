...
> Five closed items have now been carried as open across three sessions (#10
> and #11 last plan, #2, #5 and #7 this one) before anyone struck them. Each
> stale entry costs a re-investigation — paid by whoever plans next, not by
> whoever could have struck it for free while the fix was already in front
> of them.
